...
/**
 * Deze klasse heeft de eigenschappen van de kaart Appelboomgaard.
 * @author Bas, Peter, Dennis
 */
public class Appelboomgaard extends Kaart implements Serializable {

    private final Prioriteiten PRIORITEIT = Prioriteiten.BLAUW;
    private final int KOSTEN = 3;
    private final int KAARTID = 13;

    private SpelModelInterface modelInterface;

    public Appelboomgaard(int aantalKaarten){
        super(aantalKaarten);
    ...
    public ImageView kaartImage(){
        Image kaartImg = new Image(getClass().getResourceAsStream("../resources/Blauw/Appelboomgaard.png"));
