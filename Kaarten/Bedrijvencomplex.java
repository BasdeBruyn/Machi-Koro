...
/**
 * Deze klasse heeft de eigenschappen van de kaart Bedrijvencomplex
 * @author Bas, Peter, Dennis
 */
public class Bedrijvencomplex extends Kaart implements Serializable {

    private final Prioriteiten PRIORITEIT = Prioriteiten.PAARS;
    private final int KOSTEN = 8;
    private final int KAARTID = 8;

    private SpelModelInterface modelInterface;

    public Bedrijvencomplex(int aantalKaarten) {
        super(aantalKaarten);
    ...
    public void checkActivatie(int beurtSpelerID, int aantalOgen, int spelerId){
        try {
            ...
            modelInterface.bedrijvenComplexActivate(spelerId);
    ...
    public ImageView kaartImage(){
        Image kaartImg = new Image(getClass().getResourceAsStream("../resources/Paars/Bedrijvencomplex.png"));
