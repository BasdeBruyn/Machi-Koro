...
/**
 * Deze klasse heeft de eigenschappen van de kaart Graanveld
 * @author Bas, Peter, Dennis
 */
public class Graanveld extends Kaart implements Serializable {

    private final Prioriteiten PRIORITEIT = Prioriteiten.BLAUW;
    private final int KOSTEN = 1;
    private final int KAARTID = 0;

    private SpelModelInterface modelInterface;

    public Graanveld(int aantalKaarten){
        super(aantalKaarten);
    ...
    public ImageView kaartImage(){
        Image kaartImg = new Image(getClass().getResourceAsStream("../resources/Blauw/Graanveld.png"));
